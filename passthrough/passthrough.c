...
size_t write_data(void *ptr, size_t size, size_t nmemb, struct url_data *data) {
    ...
    if(tmp) {
        ...
        fprintf(stderr, "Failed to allocate memory. (write_data)\n");
        return 0;
    }
